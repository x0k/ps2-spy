...
func (m *localizedMessages) About() discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].About()
	}
}

func (m *localizedMessages) InvalidPopulationType(popType string, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].InvalidPopulationType(popType, err)
	}
}

func (m *localizedMessages) GlobalPopulationLoadError(provider string, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].GlobalPopulationLoadError(provider, err)
	}
}

func (m *localizedMessages) WorldPopulationLoadError(provider string, worldId ps2.WorldId, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldPopulationLoadError(provider, worldId, err)
	}
}

func (m *localizedMessages) GlobalPopulation(population meta.Loaded[ps2.WorldsPopulation]) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].GlobalPopulation(population)
	}
}

func (m *localizedMessages) WorldPopulation(population meta.Loaded[ps2.DetailedWorldPopulation]) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldPopulation(population)
	}
}

func (m *localizedMessages) WorldTerritoryControlLoadError(worldId ps2.WorldId, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldTerritoryControlLoadError(worldId, err)
	}
}

func (m *localizedMessages) WorldTerritoryControl(control meta.Loaded[ps2.WorldTerritoryControl]) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldTerritoryControl(control)
	}
}

func (m *localizedMessages) WorldAlertsLoadError(worldName string, worldId ps2.WorldId, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldAlertsLoadError(worldName, worldId, err)
	}
}

func (m *localizedMessages) WorldAlerts(worldName string, worldAlerts meta.Loaded[ps2.Alerts]) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].WorldAlerts(worldName, worldAlerts)
	}
}

func (m *localizedMessages) GlobalAlertsLoadError(provider string, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].GlobalAlertsLoadError(provider, err)
	}
}

func (m *localizedMessages) GlobalAlerts(alerts meta.Loaded[ps2.Alerts]) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].GlobalAlerts(alerts)
	}
}

func (m *localizedMessages) OnlineMembersLoadError(channelId discord.ChannelId, platform ps2_platforms.Platform, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
		return m.messages[locale].OnlineMembersLoadError(channelId, platform, err)
	}
}

func (m *localizedMessages) OutfitsLoadError(outfitIds []ps2.OutfitId, platform ps2_platforms.Platform, err error) discord.LocalizedEdit {
	return func(locale discord.Locale) (*discordgo.WebhookEdit, *discord.Error) {
