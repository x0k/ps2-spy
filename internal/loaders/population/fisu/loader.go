package fisu_population_loader
...
func New(client *fisu.Client) loader.Simple[meta.Loaded[ps2.WorldsPopulation]] {
	return func(ctx context.Context) (meta.Loaded[ps2.WorldsPopulation], error) {
		worldsPopulation, err := client.WorldsPopulation(ctx)
		if err != nil {
